            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-content wmin-md-350">
              ...
              <div class="dropdown-content-body dropdown-scrollable">
                <ul class="media-list">
                  <li class="media">
                    <div class="mr-3">
                      <a href="#" class="btn bg-success-400 rounded-round btn-icon">
              ...
              <div class="dropdown-content-footer bg-light">
                ...
                >All activity</a>
                <div>
                  <a href="#" class="text-grey" data-popup="tooltip" title="Clear list">
          ...
          <div class="sidebar-user-material">
            <div class="sidebar-user-material-body">
              ...
              <div class="sidebar-user-material-footer">
                <router-link
                  to="/"
                  class="d-flex justify-content-between align-items-center text-shadow-dark"
                >
          ...
          <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
              <h4>
                <button class="btn btn-default">
                  <i class="icon-profile mr-2"></i>Edit Profile
                </button>
              </h4>
            ...
            <div class="header-elements d-none">
              <div class="d-flex justify-content-center">
                ...
                >
                  <i class="icon-credit-card text-black-300"></i>
                ...
                <a
                  ...
                  class="btn btn-link btn-float font-size-sm font-weight-semibold text-default"
                >
                  <i class="icon-calculator text-black-300"></i>
                ...
                <a
                  ...
                  class="btn btn-link btn-float font-size-sm font-weight-semibold text-default"
                >
                  <i class="icon-calendar5 text-black-300"></i>
              ...
              <li class="nav-item">
                ...
                >
                  <span class="text-pink-400">
                    <i class="icon-cart2 mr-2"></i> Purchase
                  </span>
                </a>
              </li>
            </ul>
